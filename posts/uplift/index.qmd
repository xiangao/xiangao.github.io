---
title: "Uplift Modeling in Python"
author: Xiang Ao
date: '2025-10-10'
categories: [python, code, analysis]
description: "Uplift modeling with causalml, framed as conditional average treatment effect estimation."
---
...
```{python}
#| fig-alt: "Cumulative gain curves comparing uplift random forest variants against a random targeting baseline"
