---
title: "Longitudinal Modified Treatment Policies (LMTP)"
author: Xiang Ao
date: '2025-08-23'
categories: [R, code, analysis]
description: "Modified treatment policies for continuous and time-varying treatments, with TMLE and sequentially doubly robust estimation using the lmtp package."
---
...
```{r dag1, include=TRUE, warning=FALSE,  cache=FALSE, message=FALSE, echo=TRUE, fig.alt='Directed acyclic graph for a two-period longitudinal setting with time-varying treatment and confounding'}
library(ggplot2)
library(ggdag)
